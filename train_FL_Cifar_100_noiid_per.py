...
if __name__ == "__main__":
    ...
    # loadpath="save/Cifar-100-DPFL-ResNet18-noiid-classes_per_user8-num_class8-per2"
    # model_fp = os.path.join(loadpath, "checkpoint_{}.tar".format(31))
    ...
    # loadpath="save/Cifar-100-DPFL-ResNet18-noiid-classes_per_user8-num_class8-per2"
    # model_fp = os.path.join(loadpath, "clientsSavedParams_{}.tar".format(31))
