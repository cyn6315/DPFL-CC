...
def train(model, rounds):
    ...
    for r in range(rounds):
        ...
        print('Round: ', r, 'Train Loss: %.3f' % (lossPerUser/true_epoch))
        testiid(model)
        save_model2(args, model, r)
...
if __name__ == "__main__":
    ...
    loadpath="save/Cifar-100-DPFL-ResNet18-iid3"
    model_fp = os.path.join(loadpath, "checkpoint_{}.tar".format(66))
    ...
    save_model2(args, model, args.epochs)
    testiid(model)
