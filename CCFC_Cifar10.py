...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_dir', default='./save/CCFC', type=str, help='path to experiment directory')
    
    parser.add_argument('--trial', type=str, default='v4', help='trial id')
    ...
    for epoch in range(200):
        ...
        # global_centroids = get_global_centroids(args, test_loader, Nets[f'model'], device)
        # pseudo_labels = clustering_by_cosine_similarity(args, test_loader, Nets[f'model'], global_centroids, ground_truth_all.numpy(), device) 
