...
from utils import noiid_clustering, noiid_pretrain, SimSiam, clustering, centeral_clustering_by_cosine_similarity, centeral_get_global_centroids, Aggregator, centeral_pretrain, setup_seed, pretrain, asymmetric_loss, symmetric_loss, get_global_centroids, clustering_by_cosine_similarity 
from collections import defaultdict
...
class Cifar10Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        return (self.transform(self.samples[index]), self.transform(self.samples[index]), index)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_dir', default='./save/CCFC++/cifar100-noiid', type=str, help='path to experiment directory')
    ...
    parser.add_argument('--batch_size', type=int, default = 296, help='batch_size')
    parser.add_argument('--num_workers', type=int, default = 6, help='num of workers to use')
    parser.add_argument('--mini_bs', type=int, default = 148, help='mini_bs')
    ...
    parser.add_argument('--sample_ratio', type=float, default = 1, help='global_lr')
    parser.add_argument('--classes_per_user', type=int, default = 8, help='classes_per_user')
    parser.add_argument('--eta', type=float, default = 0.06, help='eta')
    ...
    Nets = {}
    Nets, agg, pseudo_labels = noiid_pretrain(Nets, args, Sample, Label, clientDataIndex, test_loader, ground_truth_all, n, trial_dir, device)
