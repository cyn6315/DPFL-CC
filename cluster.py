...
if __name__ == "__main__":
    ...
    if args.dataset == "CIFAR-10":
        ...
        train_dataset = torchvision.datasets.MNIST(
            ...
            train=True,
            download=True,
            transform=transform.Transforms(size=args.image_size,mean=0.1307,std=0.3081).test_transform,
        )
    ...
    model.load_state_dict(torch.load(model_fp,map_location=torch.device('cpu'))['net'])
    model.to(device)
