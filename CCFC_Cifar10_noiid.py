...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_dir', default='./save/CCFC/cifar10-noiid', type=str, help='path to experiment directory')
    ...
    parser.add_argument('--lbd', type=float, default = 0.5, help='trade-off hyper')
    ...
    parser.add_argument('--classes_per_user', type=int, default = 4, help='classes_per_user')
